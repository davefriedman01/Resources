...
Chambers, Bill & Matei Zaharia. (2018). [_Spark: The Definitive Guide: Big Data Processing Made Simple_](https://github.com/databricks/Spark-The-Definitive-Guide). O'Reilly.<br>
...
Parsian, Mahmoud. (2021). [_Data Algorithms with Spark: Recipes and Design Patterns for Scaling Up using PySpark_](https://github.com/mahmoudparsian/data-algorithms-with-spark). O'Reilly.<br>
Ryza, Sandy et al. (2017). [_Advanced Analytics with Spark: Patterns for Learning from Data at Scale, 2nd Ed_](https://github.com/sryza/aas). O'Reilly.<br>
