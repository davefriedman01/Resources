...
<html>
  <head>
    ...
    <title>strip-hex-prefix &#8212; Mathematics</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../_sources/nbs/z-repo_Solidity/Faucet/node_modules/strip-hex-prefix/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/davefriedman01/Resources/issues/new?title=Issue%20on%20page%20%2Fnbs/z-repo_Solidity/Faucet/node_modules/strip-hex-prefix/README.html&body=Your%20issue%20content%20here."><button
...
<a class="full-screen-button"><button type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip"
 ...
 <li class="toc-h1 nav-item toc-entry">
  <a class="reference internal nav-link" href="#important-documents">
   Important documents
  </a>
 </li>
 <li class="toc-h1 nav-item toc-entry">
  ...
  <div class="section" id="strip-hex-prefix">
<h1>strip-hex-prefix<a class="headerlink" href="#strip-hex-prefix" title="Permalink to this headline">¶</a></h1>
<div>
  <!-- Dependency Status -->
...
<br />
<p>A simple method to strip the hex prefix of a string, if present.</p>
<p>Will bypass if not a string.</p>
</div>
<div class="section" id="install">
<h1>Install<a class="headerlink" href="#install" title="Permalink to this headline">¶</a></h1>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">npm</span> <span class="n">install</span> <span class="o">--</span><span class="n">save</span> <span class="n">strip</span><span class="o">-</span><span class="nb">hex</span><span class="o">-</span><span class="n">prefix</span>
</pre></div>
</div>
</div>
<div class="section" id="usage">
<h1>Usage<a class="headerlink" href="#usage" title="Permalink to this headline">¶</a></h1>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span> <span class="nx">stripHexPrefix</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;strip-hex-prefix&#39;</span><span class="p">);</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">stripHexPrefix</span><span class="p">(</span><span class="s1">&#39;0x&#39;</span><span class="p">));</span>

<span class="c1">// result &#39;&#39;</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">stripHexPrefix</span><span class="p">(</span><span class="s1">&#39;0xhjsfdj&#39;</span><span class="p">));</span>

<span class="c1">// result &#39;hjsfdj&#39;</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">stripHexPrefix</span><span class="p">(</span><span class="s1">&#39;0x87sf7373ds8sfsdhgs73y87ssgsdf89&#39;</span><span class="p">));</span>

<span class="c1">// result &#39;87sf7373ds8sfsdhgs73y87ssgsdf89&#39;</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">stripHexPrefix</span><span class="p">({}));</span>

<span class="c1">// result {}</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">stripHexPrefix</span><span class="p">(</span><span class="s1">&#39;-0x&#39;</span><span class="p">));</span>

<span class="c1">// result &#39;-0x&#39;</span>
</pre></div>
</div>
</div>
<div class="section" id="important-documents">
<h1>Important documents<a class="headerlink" href="#important-documents" title="Permalink to this headline">¶</a></h1>
<ul class="simple">
<li><p><a class="reference internal" href="CHANGELOG.html"><span class="doc std std-doc">Changelog</span></a></p></li>
<li><p><a class="reference external" href="https://raw.githubusercontent.com/silentcicero/strip-hex-prefix/master/LICENSE">License</a></p></li>
</ul>
</div>
<div class="section" id="licence">
<h1>Licence<a class="headerlink" href="#licence" title="Permalink to this headline">¶</a></h1>
<p>This project is licensed under the MIT license, Copyright (c) 2016 Nick Dodson. For more information see <a class="reference external" href="http://LICENSE.md">LICENSE.md</a>.</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">The</span> <span class="n">MIT</span> <span class="n">License</span>

<span class="n">Copyright</span> <span class="p">(</span><span class="n">c</span><span class="p">)</span> <span class="mi">2016</span> <span class="n">Nick</span> <span class="n">Dodson</span><span class="o">.</span> <span class="n">nickdodson</span><span class="o">.</span><span class="n">com</span>
...
<span class="n">THE</span> <span class="n">SOFTWARE</span><span class="o">.</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./nbs/z-repo_Solidity/Faucet/node_modules/strip-hex-prefix"
        },
