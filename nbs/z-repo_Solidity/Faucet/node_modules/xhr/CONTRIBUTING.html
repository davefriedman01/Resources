...
<html>
  <head>
    ...
    <title>XHR is an OPEN Open Source Project &#8212; Mathematics</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../_sources/nbs/z-repo_Solidity/Faucet/node_modules/xhr/CONTRIBUTING.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/davefriedman01/Resources/issues/new?title=Issue%20on%20page%20%2Fnbs/z-repo_Solidity/Faucet/node_modules/xhr/CONTRIBUTING.html&body=Your%20issue%20content%20here."><button
...
<a class="full-screen-button"><button type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip"
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#changes-to-this-arrangement">
  ...
  <div class="section" id="xhr-is-an-open-open-source-project">
<h1>XHR is an OPEN Open Source Project<a class="headerlink" href="#xhr-is-an-open-open-source-project" title="Permalink to this headline">¶</a></h1>
<hr class="docutils" />
...
<ol class="simple">
<li><p><strong>No <code class="docutils literal notranslate"><span class="pre">--force</span></code> pushes</strong> or modifying the Git history in any way.</p></li>
<li><p><strong>Non-master branches</strong> ought to be used for ongoing work.</p></li>
<li><p><strong>External API changes and significant modifications</strong> ought to be subject to an <strong>internal pull-request</strong> to solicit feedback from other contributors.</p></li>
<li><p>Internal pull-requests to solicit feedback are <em>encouraged</em> for any other non-trivial contribution but left to the discretion of the contributor.</p></li>
<li><p>Contributors should attempt to adhere to the prevailing code-style.</p></li>
</ol>
</div>
...
<div class="section" id="changes-to-this-arrangement">
<h2>Changes to this arrangement<a class="headerlink" href="#changes-to-this-arrangement" title="Permalink to this headline">¶</a></h2>
...
<hr class="docutils" />
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./nbs/z-repo_Solidity/Faucet/node_modules/xhr"
        },
