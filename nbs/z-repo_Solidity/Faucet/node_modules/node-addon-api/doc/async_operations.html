...
<html>
  <head>
    ...
    <title>Asynchronous operations &#8212; Mathematics</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/nbs/z-repo_Solidity/Faucet/node_modules/node-addon-api/doc/async_operations.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/davefriedman01/Resources/issues/new?title=Issue%20on%20page%20%2Fnbs/z-repo_Solidity/Faucet/node_modules/node-addon-api/doc/async_operations.html&body=Your%20issue%20content%20here."><button
...
<p>Node.js native add-ons often need to execute long running tasks and to avoid
blocking the <strong>event loop</strong> they have to run them asynchronously from the
...
another thread.</p>
<p>All this means that native add-ons need to leverage async helpers from libuv as
...
completed.</p>
<p>Node Addon API provides an interface to support functions that cover
the most common asynchronous use cases. There is an abstract classes to implement
asynchronous operations:</p>
<ul class="simple">
<li><p><strong><a class="reference internal" href="async_worker.html"><span class="doc std std-doc"><code class="docutils literal notranslate"><span class="pre">Napi::AsyncWorker</span></code></span></a></strong></p></li>
</ul>
<p>These class helps manage asynchronous operations through an abstraction
of the concept of moving data between the <strong>event loop</strong> and <strong>worker threads</strong>.</p>
<p>Also, the above class may not be appropriate for every scenario. When using any
other asynchronous mechanism, the following API is necessary to ensure an
asynchronous operation is properly tracked by the runtime:</p>
<ul class="simple">
<li><p><strong><a class="reference internal" href="async_context.html"><span class="doc std std-doc">AsyncContext</span></a></strong></p></li>
<li><p><strong><a class="reference internal" href="callback_scope.html"><span class="doc std std-doc">CallbackScope</span></a></strong></p></li>
</ul>
</div>
