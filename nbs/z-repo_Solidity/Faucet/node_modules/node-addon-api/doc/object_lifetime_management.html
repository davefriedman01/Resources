...
<html>
  <head>
    ...
    <title>Object lifetime management &#8212; Mathematics</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/nbs/z-repo_Solidity/Faucet/node_modules/node-addon-api/doc/object_lifetime_management.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/davefriedman01/Resources/issues/new?title=Issue%20on%20page%20%2Fnbs/z-repo_Solidity/Faucet/node_modules/node-addon-api/doc/object_lifetime_management.html&body=Your%20issue%20content%20here."><button
...
<a class="full-screen-button"><button type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip"
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#making-handle-lifespan-shorter-than-that-of-the-native-method">
...
the default.</p>
<div class="section" id="making-handle-lifespan-shorter-than-that-of-the-native-method">
<h2>Making handle lifespan shorter than that of the native method<a class="headerlink" href="#making-handle-lifespan-shorter-than-that-of-the-native-method" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-C++ notranslate"><div class="highlight"><pre><span></span><span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">LOOP_MAX</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
  <span class="n">std</span><span class="o">::</span><span class="n">string</span> <span class="n">name</span> <span class="o">=</span> <span class="n">std</span><span class="o">::</span><span class="n">string</span><span class="p">(</span><span class="s">&quot;inner-scope&quot;</span><span class="p">)</span> <span class="o">+</span> <span class="n">std</span><span class="o">::</span><span class="n">to_string</span><span class="p">(</span><span class="n">i</span><span class="p">);</span>
  <span class="n">Napi</span><span class="o">::</span><span class="n">Value</span> <span class="n">newValue</span> <span class="o">=</span> <span class="n">Napi</span><span class="o">::</span><span class="n">String</span><span class="o">::</span><span class="n">New</span><span class="p">(</span><span class="n">info</span><span class="p">.</span><span class="n">Env</span><span class="p">(),</span> <span class="n">name</span><span class="p">.</span><span class="n">c_str</span><span class="p">());</span>
  <span class="c1">// do something with newValue</span>
<span class="p">};</span>
</pre></div>
</div>
...
associated with the scope are invalidated. The <code class="docutils literal notranslate"><span class="pre">Napi::HandleScope</span></code>
and <code class="docutils literal notranslate"><span class="pre">Napi::EscapableHandleScope</span></code> classes are provided by node-addon-api for
...
<code class="docutils literal notranslate"><span class="pre">Napi::HandleScopes</span></code> are typically stack allocated the compiler will take care of
deletion, however, care must be taken to create the scope in the right
place such that you achieve the desired lifetime.</p>
<p>Taking the earlier example, creating a <code class="docutils literal notranslate"><span class="pre">Napi::HandleScope</span></code> in the innner loop
would ensure that at most a single new value is held alive throughout the
execution of the loop:</p>
<div class="highlight-C notranslate"><div class="highlight"><pre><span></span><span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">LOOP_MAX</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
  <span class="n">Napi</span><span class="o">::</span><span class="n">HandleScope</span> <span class="nf">scope</span><span class="p">(</span><span class="n">info</span><span class="p">.</span><span class="n">Env</span><span class="p">());</span>
  <span class="n">std</span><span class="o">::</span><span class="n">string</span> <span class="n">name</span> <span class="o">=</span> <span class="n">std</span><span class="o">::</span><span class="n">string</span><span class="p">(</span><span class="s">&quot;inner-scope&quot;</span><span class="p">)</span> <span class="o">+</span> <span class="n">std</span><span class="o">::</span><span class="n">to_string</span><span class="p">(</span><span class="n">i</span><span class="p">);</span>
  <span class="n">Napi</span><span class="o">::</span><span class="n">Value</span> <span class="n">newValue</span> <span class="o">=</span> <span class="n">Napi</span><span class="o">::</span><span class="n">String</span><span class="o">::</span><span class="n">New</span><span class="p">(</span><span class="n">info</span><span class="p">.</span><span class="n">Env</span><span class="p">(),</span> <span class="n">name</span><span class="p">.</span><span class="n">c_str</span><span class="p">());</span>
  <span class="c1">// do something with neValue</span>
<span class="p">};</span>
</pre></div>
</div>
...
provides the <code class="docutils literal notranslate"><span class="pre">Napi::EscapableHandleScope</span></code> with the <code class="docutils literal notranslate"><span class="pre">Escape</span></code> method
in order to support this case. An escapable scope
allows one object to be ‘promoted’ so that it ‘escapes’ the
current scope and the lifespan of the handle changes from the current
scope to that of the outer scope. The <code class="docutils literal notranslate"><span class="pre">Escape</span></code> method can only be called
once for a given <code class="docutils literal notranslate"><span class="pre">Napi::EscapableHandleScope</span></code>.</p>
</div>
</div>
