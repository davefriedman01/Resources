...
<html>
  <head>
    ...
    <title>Ajv: Another JSON Schema Validator &#8212; Mathematics</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../_sources/nbs/z-repo_Solidity/Faucet/node_modules/ajv/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/davefriedman01/Resources/issues/new?title=Issue%20on%20page%20%2Fnbs/z-repo_Solidity/Faucet/node_modules/ajv/README.html&body=Your%20issue%20content%20here."><button
...
<div class="section" id="ajv-v7-beta-is-released">
...
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>npm install ajv@beta
</pre></div>
</div>
...
<div class="section" id="mozilla-moss-grant-and-openjs-foundation">
...
<p>Try it in the Node.js REPL: <a class="reference external" href="https://tonicdev.com/npm/ajv">https://tonicdev.com/npm/ajv</a></p>
...
<span class="k">import</span> <span class="nx">Ajv</span> <span class="k">from</span> <span class="s1">&#39;ajv&#39;</span><span class="p">;</span>
...
<p>Example in Node.js REPL: <a class="reference external" href="https://tonicdev.com/esp/ajv-asynchronous-validation">https://tonicdev.com/esp/ajv-asynchronous-validation</a></p>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kd">const</span> <span class="nx">isSchemaSecure</span> <span class="o">=</span> <span class="nx">ajv</span><span class="p">.</span><span class="nx">compile</span><span class="p">(</span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;ajv/lib/refs/json-schema-secure.json&#39;</span><span class="p">));</span>

<span class="kd">const</span> <span class="nx">schema1</span> <span class="o">=</span> <span class="p">{</span><span class="nx">format</span><span class="o">:</span> <span class="s1">&#39;email&#39;</span><span class="p">};</span>
...
<span class="kd">const</span> <span class="nx">schema2</span> <span class="o">=</span> <span class="p">{</span><span class="nx">format</span><span class="o">:</span> <span class="s1">&#39;email&#39;</span><span class="p">,</span> <span class="nx">maxLength</span><span class="o">:</span> <span class="nx">MAX_LENGTH</span><span class="p">};</span>
...
<p>There is no need to explicitly add draft-07 meta schema (<a class="reference external" href="http://json-schema.org/draft-07/schema">http://json-schema.org/draft-07/schema</a>) - it is added by default, unless option <code class="docutils literal notranslate"><span class="pre">meta</span></code> is set to <code class="docutils literal notranslate"><span class="pre">false</span></code>. You only need to use it if you have a changed meta-schema that you want to use to validate your schemas. See <code class="docutils literal notranslate"><span class="pre">validateSchema</span></code>.</p>
</div>
...
<li><p><em>type</em>: an optional type of data that the format applies to. It can be <code class="docutils literal notranslate"><span class="pre">&quot;string&quot;</span></code> (default) or <code class="docutils literal notranslate"><span class="pre">&quot;number&quot;</span></code> (see <a class="reference external" href="https://github.com/ajv-validator/ajv/issues/291#issuecomment-259923858">https://github.com/ajv-validator/ajv/issues/291#issuecomment-259923858</a>). If the type of data is different, the validation will pass.</p></li>
</ul>
...
<li><p><a class="reference external" href="https://github.com/josdejong/jsoneditor">jsoneditor</a> - a web-based tool to view, edit, format, and validate JSON <a class="reference external" href="http://jsoneditoronline.org">http://jsoneditoronline.org</a></p></li>
<li><p><a class="reference external" href="https://github.com/nickcmaynard/jsonschemalint">JSON Schema Lint</a> - a web tool to validate JSON/YAML document against a single JSON Schema <a class="reference external" href="http://jsonschemalint.com">http://jsonschemalint.com</a></p></li>
...
<p>See <a class="reference external" href="https://github.com/ajv-validator/ajv/releases">https://github.com/ajv-validator/ajv/releases</a></p>
...
<p>Please report any unacceptable behaviour to <a class="reference external" href="mailto:ajv&#46;validator&#37;&#52;&#48;gmail&#46;com">ajv<span>&#46;</span>validator<span>&#64;</span>gmail<span>&#46;</span>com</a> - it will be reviewed by the project team.</p>
</div>
...
<p><a class="reference external" href="https://github.com/ajv-validator/ajv/blob/master/LICENSE">MIT</a></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./nbs/z-repo_Solidity/Faucet/node_modules/ajv"
        },
