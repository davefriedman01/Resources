...
<html>
  <head>
    ...
    <title>window.fetch polyfill &#8212; Mathematics</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../_sources/nbs/z-repo_Solidity/Faucet/node_modules/whatwg-fetch/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/davefriedman01/Resources/issues/new?title=Issue%20on%20page%20%2Fnbs/z-repo_Solidity/Faucet/node_modules/whatwg-fetch/README.html&body=Your%20issue%20content%20here."><button
...
Make sure you read this <em>entire</em> readme, especially the <a class="reference external" href="#caveats">Caveats</a>
...
<a class="reference external" href="https://github.github.io/fetch/">https://github.github.io/fetch/</a>.</p>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="k">import</span> <span class="s1">&#39;whatwg-fetch&#39;</span>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="k">import</span> <span class="p">{</span><span class="nx">fetch</span> <span class="k">as</span> <span class="nx">fetchPolyfill</span><span class="p">}</span> <span class="k">from</span> <span class="s1">&#39;whatwg-fetch&#39;</span>
...
<li><p><code class="docutils literal notranslate"><span class="pre">keepalive</span></code> is not supported because it would involve making a synchronous XHR, which is something this project is not willing to do. See <a class="reference external" href="https://github.com/github/fetch/issues/700#issuecomment-484188326">issue #700</a> for more information.</p></li>
</ul>
...
<a class="reference external" href="https://www.npmjs.com/package/yet-another-abortcontroller-polyfill">an additional polyfill</a>
for these APIs to abort fetches:</p>
<div class="highlight-js notranslate"><div class="highlight"><pre><span></span><span class="k">import</span> <span class="s1">&#39;yet-another-abortcontroller-polyfill&#39;</span>
<span class="k">import</span> <span class="p">{</span><span class="nx">fetch</span><span class="p">}</span> <span class="k">from</span> <span class="s1">&#39;whatwg-fetch&#39;</span>

<span class="c1">// use native browser implementation if it supports aborting</span>
<span class="kd">const</span> <span class="nx">abortableFetch</span> <span class="o">=</span> <span class="p">(</span><span class="s1">&#39;signal&#39;</span> <span class="k">in</span> <span class="k">new</span> <span class="nx">Request</span><span class="p">(</span><span class="s1">&#39;&#39;</span><span class="p">))</span> <span class="o">?</span> <span class="nb">window</span><span class="p">.</span><span class="nx">fetch</span> <span class="o">:</span> <span class="nx">fetch</span>
...
an issue with that browser vendor instead of this project.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./nbs/z-repo_Solidity/Faucet/node_modules/whatwg-fetch"
        },
