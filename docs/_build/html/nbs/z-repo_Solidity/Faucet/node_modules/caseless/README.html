...
<html>
  <head>
    ...
    <title>Caseless – wrap an object to set and get property with caseless semantics but also preserve caseing. &#8212; Mathematics</title>
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../_sources/nbs/z-repo_Solidity/Faucet/node_modules/caseless/README.md"><button type="button"
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons sourcebuttons">
        ...
        <a class="issues-button"
            href="https://github.com/davefriedman01/Resources/issues/new?title=Issue%20on%20page%20%2Fnbs/z-repo_Solidity/Faucet/node_modules/caseless/README.html&body=Your%20issue%20content%20here."><button
...
<a class="full-screen-button"><button type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip"
 ...
 <li class="toc-h1 nav-item toc-entry">
  <a class="reference internal nav-link" href="#has-key">
   has(key)
  </a>
 </li>
 <li class="toc-h1 nav-item toc-entry">
  <a class="reference internal nav-link" href="#set-key-value-clobber-true">
   set(key, value[, clobber=true])
  </a>
 </li>
 <li class="toc-h1 nav-item toc-entry">
  <a class="reference internal nav-link" href="#swap-key">
   swap(key)
  </a>
 </li>
</ul>
  ...
  <div class="section" id="caseless-wrap-an-object-to-set-and-get-property-with-caseless-semantics-but-also-preserve-caseing">
<h1>Caseless – wrap an object to set and get property with caseless semantics but also preserve caseing.<a class="headerlink" href="#caseless-wrap-an-object-to-set-and-get-property-with-caseless-semantics-but-also-preserve-caseing" title="Permalink to this headline">¶</a></h1>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="kd">var</span> <span class="nx">headers</span> <span class="o">=</span> <span class="p">{}</span>
...
<h1>has(key)<a class="headerlink" href="#has-key" title="Permalink to this headline">¶</a></h1>
...
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="nx">c</span><span class="p">.</span><span class="nx">has</span><span class="p">(</span><span class="s1">&#39;a-header&#39;</span><span class="p">)</span> <span class="o">===</span> <span class="s1">&#39;a-Header&#39;</span>
</pre></div>
</div>
</div>
<div class="section" id="set-key-value-clobber-true">
<h1>set(key, value[, clobber=true])<a class="headerlink" href="#set-key-value-clobber-true" title="Permalink to this headline">¶</a></h1>
<p>Set is fairly straight forward except that if the header exists and clobber is disabled it will add <code class="docutils literal notranslate"><span class="pre">','+value</span></code> to the existing header.</p>
<div class="highlight-javascript notranslate"><div class="highlight"><pre><span></span><span class="nx">c</span><span class="p">.</span><span class="nx">set</span><span class="p">(</span><span class="s1">&#39;a-Header&#39;</span><span class="p">,</span> <span class="s1">&#39;fdas&#39;</span><span class="p">)</span>
...
<div class="section" id="swap-key">
<h1>swap(key)<a class="headerlink" href="#swap-key" title="Permalink to this headline">¶</a></h1>
...
<span class="nx">headers</span> <span class="o">===</span> <span class="p">{</span><span class="s1">&#39;a-HEADER&#39;</span><span class="o">:</span> <span class="s1">&#39;fdas&#39;</span><span class="p">}</span>
</pre></div>
</div>
</div>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./nbs/z-repo_Solidity/Faucet/node_modules/caseless"
        },
